...
import com.api.nomina.datos.DDetalleNominaM;
...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/detallenominaM")
public class resGenerarNominaM {

    @Autowired
    private DDetalleNominaM ddetalleNomina;
    ...
    public ResponseEntity<?> obtenerDetalle(@PathVariable Integer idPeriodo) {
        try {
            List<EDetalleNominaM> detalle = ddetalleNomina.obtenerDetalle(idPeriodo);
