...
public class DNomina {
    ...
    public void crearNomina(
        ...
        nominaRepositorio.spGestionNomina(
            "CREATE", null, tipo, periodoInicio, periodoFin, fechaGeneracion, estado, idPeriodo
        );
    }
    ...
    public void actualizarNomina(
        ...
        nominaRepositorio.spGestionNomina(
            "UPDATE", idNomina, tipo, periodoInicio, periodoFin, fechaGeneracion, estado, idPeriodo
        );
    }

    public void eliminarNomina(Integer idNomina) {
        nominaRepositorio.spGestionNomina(
            "DELETE", idNomina, null, null, null, null, null, null
        );
    }

    @Transactional(readOnly = true)
    public List<ENomina> listarNominas() {
        return nominaRepositorio.spNominaListar(
    ...
    public ENomina buscarNominaPorId(Integer idNomina) {
        List<ENomina> resultado = nominaRepositorio.spNominaListar(
            "READ_ID", idNomina, null, null, null, null, null, null
        );
